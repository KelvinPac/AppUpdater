...
public class Update {
    ...
    //public static String JSON_URL = "http://homeautogroup.co.ke/kyu/login/update.php";

    private  String JSON_URL = "http://192.168.56.1/app_login/updates/update.php";
    ...
    void setJsonUrl(String jsonUrl) {
        JSON_URL = jsonUrl;
    }
